            ...
            <div class="col-lg-12">
                    <div class="card">
                        ...
                        <?php foreach($this->data['AssessmentLayout']->result_array() as $row): ?>
                            ...
                            <?php
                                ...
                                if($row['QuestionAnswer'] == $row['Answer']){
                                    ...
                                    //echo 'right'.$total_points;
                                }
                                //echo $row['QuestionAnswer'].'<br>';
                                //echo $row['Answer'].'<br>';
                            ?>
                            <?php
                        ...
                        <div class="header">
                            ...
                            <h1 style="color:#cc0000"><u>SCORE: <?php echo $total_points; ?></u></h1>
                            <br><br>
                        ...
                        <div class="body">
                            <table class="table table-striped dashboard-task-info">
                                ...
                                <?php 
                                    ...
                                    $answerhighlight = 'color:#FF0000';
                                    if($row['QuestionAnswer'] == $row['Answer']){
                                        $answerhighlight = 'color:#008000';
                                    }
                                ...
                                <?php $count++; ?>
                                    ...
                                    <h3>Answered: <span style="<?php echo $answerhighlight; ?>"><u><?php echo $row['QuestionAnswer']; ?></u></span></h3>
                                    <br><br>
                                    </td>
                                    <td>
                                        <div class="list-group" style="color:#000">
                                            ...
                                            <?php if($row['QuestionTypeID'] == 1): ?>
                                                ...
                                                if($row['Answer'] == $row['Choice_A']){
                                                    ...
                                                    $Bclass = "list-group-item-success";
                                                    $Bfont = "color:#fff";
                                                }
                                                else if($row['Answer'] == $row['Choice_C']){
                                                    $Cclass = "list-group-item-success";
                                                    $Cfont = "color:#fff";
                                                }
                                                else if($row['Answer'] == $row['Choice_D']){
                                                    $Dclass = "list-group-item-success";
                                                    $Dfont = "color:#fff";
                                                }
                                                ?>
